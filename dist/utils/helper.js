...
exports.resetPasswordEmailTemplate = exports.forgotPasswordEmailTemplate = exports.mailTransport = void 0;
const nodemailer_1 = __importDefault(require("nodemailer"));
const forgotPasswordEmailTemplate = (URL, name) => {
    return (`<!DOCTYPE html>
<html lang="en" >
<head>
<meta charset="UTF-8">
...
const resetPasswordEmailTemplate = (URL, name) => {
    return (`<!DOCTYPE html>
<html lang="en" >
<head>
<meta charset="UTF-8">
